...
// Class to make recommendation based on geo distance and similar categories.
public class GeographicalRecommendation implements Recommendation {

	@Override
	public List<Item> recommendItems(String userId, double lat, double lon) {
		DatabaseConnection conn = DatabaseConnectionFactory.getDBConnection();
		...
		// step 5. perform ranking of these items based on distance. Nearest will be the
		// first to recommend
